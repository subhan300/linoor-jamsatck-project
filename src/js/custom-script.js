(function ($) {
  ...
  function headerStyle() {
    if ($(".main-header").length) {
      ...
      if (windowpos > 120) {
        ...
        $(".dropdowns .dropdown-menus").css("background","black");
      } else {
        siteHeader.removeClass("fixed-header");
        sticky_header.removeClass("animated slideInDown");
        $(".dropdowns .dropdown-menus").css("background","");
      }
    }
  }
  ...
  var header_height = $(".header-upper").height();
  $(".mega_menu").css("top",header_height+10);

  $(".mega_1").mouseenter(function () {
		$(".mega_menu").addClass("mega_open");
    $(".mega_menu").css({
  ...
  $(".mega_1").click(function (e) {
		$(".mega_menu").toggleClass("mega_open_mob");
    if ($(".mega_menu").has("mega_open_mob")) {
      e.preventDefault();
    }
	})
  ...
  document.addEventListener("mouseup", function (event) {
    ...
    if (event.target.closest(".mega_menu")) return;
  
    // If user clicks outside the element, hide it!
    else if ($(".mega_menu").hasClass("mega_open_mob") == true) {
      $(".mega_menu").toggleClass("mega_open_mob")
    }
  });
  ...
  $('.dropdowns').click(function () {
    ...
    $(this).find('.dropdown-menus').toggle();
});
...
$('.dropdowns .dropdown-menus li').click(function () {
 ...
 document.getElementById('auto_year').innerHTML = "2021-"+year;
